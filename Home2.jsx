...
export default function Home() {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem('user'); // Also clean up the user profile key from your script
    setIsLoggedIn(false);
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      // Set items identically to your original script.js expectations
    ...
    <>
      ...
      {isModalOpen && (
        <div 
          ...
          onClick={(e) => e.target.className === 'modal' && setIsModalOpen(false)}
        >
